                ...
                <ul class="list-unstyled menu-categories" id="topAccordion">
                  ...
                  <li class="menu single-menu">
                    ...
                    >
                      ...
                      <li>
                        <a href="component_session_timeout.html">
                          Session Timeout
                        </a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="component_pricing_table.html">
                          Pricing Tables
                        </a>
                      </li>
                      <li>
                    ...
                    >
                      ...
                      <li class="sub-sub-submenu-list">
                        ...
                        >
                          ...
                          <li>
                            <a href="table_dt_striped_table.html">
                              Striped Table
                            </a>
                          </li>
                          <li>
                            <a href="table_dt_ordering_sorting.html">
                              Order Sorting
                            </a>
                          </li>
                          <li>
                            <a href="table_dt_multi-column_ordering.html">
                              Multi-Column
                            </a>
                          </li>
                          <li>
                            <a href="table_dt_multiple_tables.html">
                              Multiple Tables
                            </a>
                          </li>
                          <li>
                            <a href="table_dt_alternative_pagination.html">
                              Alt. Pagination
                            </a>
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="table_dt_range_search.html">
                              Range Search
                            </a>
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="table_dt_live_dom_ordering.html">
                              Live DOM ordering
                            </a>
                          </li>
                          <li>
                            <a href="table_dt_miscellaneous.html">
                              Miscellaneous
                            </a>
                          </li>
                        </ul>
                  ...
                  <li class="menu single-menu">
                    ...
                    >
                      ...
                      <li>
                        <a href="form_checkbox_radio.html">
                          Checkbox &amp; Radio
                        </a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="form_date_range_picker.html">
                          Date &amp; Range Picker
                        </a>
                      </li>
                      <li>
                    ...
                    >
                      <div class="">
                        <span>
                          ...
                          <span class="d-xl-none">More</span>
                        </span>
                      </div>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    >
                      <li class="sub-sub-submenu-list">
                        ...
                        >
                          ...
                          <li>
                            <a href="pages_coming_soon.html" target="_blank">
                              Coming Soon
                            </a>
                          </li>
                          <li>
                          ...
                          <li class="sub-sub-submenu-list">
                            ...
                            >
                              <li>
                                <a href="pages_error404.html" target="_blank">
                                  404
                                </a>
                              </li>
                              <li>
                                <a href="pages_error500.html" target="_blank">
                                  500
                                </a>
                              </li>
                              <li>
                                <a href="pages_error503.html" target="_blank">
                                  503
                                </a>
                              </li>
                              <li>
                                <a
                                  href="pages_maintenence.html"
                                  target="_blank"
                                >
                                  Maintanence
                                </a>
                          ...
                          <li class="sub-sub-submenu-list">
                            ...
                            >
                              <li>
                                <a href="auth_login.html" target="_blank">
                                  Login
                                </a>
                              </li>
                              <li>
                                <a href="auth_login_boxed.html" target="_blank">
                                  Login Boxed
                                </a>
                              </li>
                            </ul>
                          ...
                          <li class="sub-sub-submenu-list">
                            ...
                            >
                              <li>
                                <a href="auth_register.html" target="_blank">
                                  Register
                                </a>
                              </li>
                              <li>
                                <a
                                  href="auth_register_boxed.html"
                                  target="_blank"
                                >
                                  Register Boxed
                                </a>
                          ...
                          <li class="sub-sub-submenu-list">
                            ...
                            >
                              <li>
                                <a href="auth_lockscreen.html" target="_blank">
                                  Unlock
                                </a>
                              </li>
                              <li>
                                <a
                                  href="auth_lockscreen_boxed.html"
                                  target="_blank"
                                >
                                  Unlock Boxed
                                </a>
