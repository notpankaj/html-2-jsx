...
const scripts = ` var loaderElement = document.querySelector('#load_screen');
setTimeout( function() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (email && password) {
      ...
      if (response?.code === "200") {
        toast(response.msg || "login! success");
        doLogin(response.data);
      } else {
        toast(response.msg || "failed to login!");
      }
    } else {
                ...
                <div class="form-content">
                  ...
                  <form class="text-left" onSubmit={handleSubmit}>
                    <div class="form">
                      ...
                      <p class="signup-link">
                        Not registered ?{" "}
                        {/* <a href="auth_register_boxed.html">Create an account</a> */}
                        <Link to="/auth_register">Create an account</Link>
                      </p>
                    </div>
                  </form>
                </div>
