function Chat() {
  return (
    <>
      ...
      <link
        href="assets/css/apps/mailing-chat.css"
        rel="stylesheet"
        type="text/css"
      />
                      ...
                      <div class="people">
                        ...
                        <div class="person" data-chat="person2">
                          <div class="user-info">
                            ...
                            <div class="f-body">
                              <div class="meta-info">
                                <span class="user-name" data-name="Alma Clarke">
                                  Alma Clarke
                                </span>
                        ...
                        <div class="person" data-chat="person3">
                          <div class="user-info">
                            ...
                            <div class="f-body">
                              <div class="meta-info">
                                <span class="user-name" data-name="Alan Green">
                                  Alan Green
                                </span>
                                <span class="user-meta-time">2:09 PM</span>
                              </div>
                        ...
                        <div class="person" data-chat="person4">
                          <div class="user-info">
                            ...
                            <div class="f-body">
                              <div class="meta-info">
                                <span class="user-name" data-name="Shaun Park">
                                  Shaun Park
                                </span>
                                <span class="user-meta-time">2:09 PM</span>
                              </div>
                        ...
                        <div class="person" data-chat="person5">
                          <div class="user-info">
                            ...
                            <div class="f-body">
                              <div class="meta-info">
                                <span class="user-name" data-name="Roxanne">
                                  Roxanne
                                </span>
                                <span class="user-meta-time">2:09 PM</span>
                              </div>
                              <span class="preview">
                                Wasup for the third time like is you bling bitch
                              </span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="person" data-chat="person8">
                          <div class="user-info">
                            ...
                            <div class="f-body">
                              <div class="meta-info">
                                <span class="user-name" data-name="Laurie Fox">
                                  Laurie Fox
                                </span>
                                <span class="user-meta-time">2:09 PM</span>
                              </div>
                        ...
                        <div class="person" data-chat="person9">
                          <div class="user-info">
                            ...
                            <div class="f-body">
                              <div class="meta-info">
                                <span class="user-name" data-name="Xavier">
                                  Xavier
                                </span>
                                <span class="user-meta-time">2:09 PM</span>
                              </div>
                        ...
                        <div class="person" data-chat="person11">
                          <div class="user-info">
                            ...
                            <div class="f-body">
                              <div class="meta-info">
                                <span class="user-name" data-name="Dale Butler">
                                  Dale Butler
                                </span>
                                <span class="user-meta-time">2:09 PM</span>
                              </div>
                        ...
                        <div class="chat-conversation-box">
                          ...
                          >
                            ...
                            <div class="chat" data-chat="person3">
                              ...
                              <div class="bubble me">Hey Buddy.</div>
                              <div class="bubble me">What's up</div>
                              <div class="bubble you">I am sick</div>
                              <div class="bubble you">
                            ...
                            <div class="chat" data-chat="person6">
                              ...
                              <div class="bubble you">How are you?</div>
                              <div class="bubble me">Welcom Back</div>
                              <div class="bubble me">I am all well</div>
                              <div class="bubble you">Coffee?</div>
                            </div>
                            <div class="chat" data-chat="person7"></div>
                            <div class="chat" data-chat="person8"></div>
                            <div class="chat" data-chat="person9"></div>
                            <div class="chat" data-chat="person10"></div>
                            <div class="chat" data-chat="person11"></div>
                            <div class="chat" data-chat="person12"></div>
                          </div>
                        </div>
